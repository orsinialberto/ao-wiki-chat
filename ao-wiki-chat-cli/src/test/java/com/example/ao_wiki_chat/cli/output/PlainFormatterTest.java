...
/**
 * Unit tests for PlainFormatter.
 */
class PlainFormatterTest {

    private final PlainFormatter formatter = new PlainFormatter();
    ...
    @Test
    void formatDocumentsWhenListProvidedReturnsPlainText() {
        ...
        assertThat(result).contains("Total documents");
    ...
    @Test
    void formatDocumentWhenProvidedReturnsPlainText() {
    ...
    @Test
    void formatMetadataWhenProvidedReturnsPlainText() {
    ...
    @Test
    void formatChatResponseWhenProvidedReturnsPlainText() {
    ...
    @Test
    void formatHistoryWhenProvidedReturnsPlainText() {
    ...
    @Test
    void formatChunksWhenProvidedReturnsPlainText() {
        ...
        assertThat(result).contains("Total chunks");
